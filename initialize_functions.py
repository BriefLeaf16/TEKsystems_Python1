...
The definition of a function specifies its name and the data the function needs to work. Parameters are the variables in the function that hold this data.
'''
...
def are_you_bob():
    ...
    if name == 'bob' or name == 'Bob' or name == 'BOB':
        return True
    else:
        return False