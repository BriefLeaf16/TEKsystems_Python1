...
print("Hello, my name is " + first_name + " " + last_name + " and I am " + my_age + " years old.")
print("Hello, my name is %s %s and I am %s years old." %(first_name, last_name, my_age))
print("Hello, my name is " + " ".join([first_name, last_name])  + " and I am " + "".join(my_age) +" years old")
...
'''
A while loop runs as long as a certain condition is true. Say you have a game loop that runs as long as a game_active variable is set to True. You can then put mul-tiple
 situations inside the loop that cause game_active to become False and end the game. You can also use a while loop to process items in a collection that might have new items added to it as the loop is running.
...
to_do_list = ['exercise', 'work', 'shopping', 'eat', 'sleep']
groceries = ['bread', 'eggs', 'milk', 'chicken', 'fish']
random_numbers = [12,34,123,555]
...
cars_dict = {'Supra': 'Toyota', 'Skyline': 'Nissan', 'Miata':'Mazda', 'Civic': 'Honda', 'Evo':'Mitsubishi'}
